...
- (void)request:(CamerasListXMLRequest *)theRequest didProduceResponse:(NSDictionary *)theResponse withStatus:(BOOL)success {
    if (!success)
    {
...
{
    //DBLog(@"CameraGridCell being reused");
