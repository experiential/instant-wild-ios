//
//  InstantWildSHKConfigurator.m
//  instantWild
//
//  Created by James Sanford on 06/03/2013.
//
//
...
@implementation InstantWildSHKConfigurator
...
- (NSString*)appURL {
    return [NSString stringWithFormat:@"http://%@/instantwild/", serverDomain];
}
...
- (NSString*)facebookAppId {
	return @"126868267420937";
}
- (NSString*)facebookAppId { // Iwt
 return @"613437265352226";
}
*/
- (NSString*)facebookAppId {
	return @"126868267420937";
...
- (NSString*)googlePlusClientId {
    return @"596936852156.apps.googleusercontent.com";
}

// Read It Later - http://readitlaterlist.com/api/signup/
- (NSString*)readItLaterKey {
	return @"d90TcDcHg7124r66cHd15d5Lf9pdb04f";
}

// Diigo - http://www.diigo.com/api_keys/new/
- (NSString*)diigoKey {
    return @"cbe07ca6a54ca577";
}
...
- (NSString*)twitterConsumerKey {
	return @"RqYJMqKJN8YzsUPd3WAQ";
}

- (NSString*)twitterSecret {
	return @"Uw6OQRe874Y7I63eksPWVllwtFtOBcPUjV09herk";
}
// You need to set this if using OAuth, see note above (xAuth users can skip it)
- (NSString*)twitterCallbackUrl {
	return @"http://www.edgeofexistence.org/instant_wild/mobile_apps/twitter_callback.php";
}
...
- (NSString*)bitLyLogin {
	return @"jamesthaimassage";
}

- (NSString*)bitLyKey {
	return @"R_b997d50369e84561fa8a3fe8aae5e15b";
}
...
- (NSString*)linkedInSecret {
	return @"NSxUNgB4IKDiyl3s";
}

- (NSString*)linkedInCallbackUrl {
	return @"http://www.edgeofexistence.org/instant_wild/mobile_apps/linkedin_callback.php";
}
...
- (NSString*)tumblrConsumerKey {
	return @"tBN5qzjQbh0hYhoWzZMcp1mdk5clebJdRNX2wIPi0VNGPCikN4";
}

- (NSString*)tumblrSecret {
	return @"XpmsmhFfmyTfVj8ShggAuak00UqD1ZJCFR3wDlQKuGx2KKNFpz";
}
...
- (NSString*)tumblrCallbackUrl {
	return @"http://www.edgeofexistence.org/instant_wild/mobile_apps/tumblr_callback.php";
}
...
- (NSArray*)defaultFavoriteURLSharers {
    return [NSArray arrayWithObjects:@"SHKTwitter",@"SHKFacebook", @"SHKGooglePlus", nil];
}
